...
#line 31
 testRunner.Then("I should get HTTP 200", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line 32
 testRunner.And("I should get an the following JSON response: [{\"shortName\":\"dev\",\"longName\":null," +
                    "\"description\":null,\"icon\":null,\"link\":\"/environments/dev\"},{\"shortName\":\"test\",\"" +
                    "longName\":null,\"description\":null,\"icon\":null,\"link\":\"/environments/test\"}]", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
            this.ScenarioCleanup();
        }
