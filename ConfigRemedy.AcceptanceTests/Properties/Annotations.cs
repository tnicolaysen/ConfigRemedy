...
namespace ConfigRemedy.AcceptanceTests.Annotations
{
  /// <summary>
  ...
  /// </summary>
  [AttributeUsage(AttributeTargets.Class, AllowMultiple = false, Inherited = true), MeansImplicitUse(ImplicitUseTargetFlags.WithMembers)]
